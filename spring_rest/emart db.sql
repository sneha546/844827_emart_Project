...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2020 at 12:42 PM
...
(5, 'credit', '2020-03-04', 'paid', 22000, 1),
(21, 'credit', '2020-03-05', 'paid', 42000, 1),
(22, 'credit', '2020-03-05', 'paid', 40000, 1),
(23, 'credit', '2020-03-06', 'paid', 141200, 1),
(24, 'credit', '2020-03-06', 'paid', 62000, 1);
...
--
ALTER TABLE `bill_details_table`
  MODIFY `bill_details_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `bill_table`
--
ALTER TABLE `bill_table`
  MODIFY `bill_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
